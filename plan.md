...
- Render runtime fix: backend Docker CMD now binds Uvicorn to `${PORT:-8000}` so Render can detect the open web service port while local Docker still defaults to port 8000.
